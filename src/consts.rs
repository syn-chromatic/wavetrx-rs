...
// Protocol Profile
pub const MARKER_TONE_START: f32 = 13_000.0;
pub const MARKER_TONE_END: f32 = 16_000.0;
pub const MARKER_TONE_NEXT: f32 = 5_000.0;

pub const BIT_TONE_HIGH: f32 = 9_000.0;
pub const BIT_TONE_LOW: f32 = 1_000.0;

pub const PULSE_LENGTH_US: Duration = Duration::from_micros(500);
pub const PULSE_GAP_US: Duration = Duration::from_micros(1000);
